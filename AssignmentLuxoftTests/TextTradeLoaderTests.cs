...
namespace AssignmentLuxoftTests
{
    ...
    public class TextTradeLoaderTests
    {
        private TextTradeLoader sut;

        public TextTradeLoaderTests()
        {
            sut= new TextTradeLoader();
            
        }

        [Fact]
        public void SupportedSourceType_ShouldBe_Txt()
        {
            var expected = ".txt";
        ...
        {
            using (var fs = new FileStream(TestConfig.PathToTextFile, FileMode.Open))
            {
