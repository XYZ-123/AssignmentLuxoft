...
namespace AssignmentLuxoftTests
{
    ...
    public class CsvTradeLoaderTests
    {
        private CsvTradeLoader sut;

        public CsvTradeLoaderTests()
        {
            sut = new CsvTradeLoader();
        }

        [Fact]
        public void SupportedSourceType_ShouldBe_csv()
        {
            var expected = ".csv";
